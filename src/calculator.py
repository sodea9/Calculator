...
icon = tk.PhotoImage(file="Assets/calcicon.png")
...
StdButton(main, text="7", command=lambda: num_button(7, display, operator)).grid(column=1, row=3)
StdButton(main, text="8", command=lambda: num_button(8, display, operator)).grid(column=2, row=3)
StdButton(main, text="9", command=lambda: num_button(9, display, operator)).grid(column=3, row=3)
...
StdButton(main, text="4", command=lambda: num_button(4, display, operator)).grid(column=1, row=4)
StdButton(main, text="5", command=lambda: num_button(5, display, operator)).grid(column=2, row=4)
StdButton(main, text="6", command=lambda: num_button(6, display, operator)).grid(column=3, row=4)
...
StdButton(main, text="1", command=lambda: num_button(1, display, operator)).grid(column=1, row=5)
StdButton(main, text="2", command=lambda: num_button(2, display, operator)).grid(column=2, row=5)
StdButton(main, text="3", command=lambda: num_button(3, display, operator)).grid(column=3, row=5)
StdButton(main, text="+", command=lambda: test()).grid(column=4, row=5, rowspan=2, sticky=(N,S))
StdButton(main, text="AC", command=lambda: all_clear(display, memory)).grid(column=0, row=6)
StdButton(main, text="0", command=lambda: num_button(0, display, operator)).grid(column=1, row=6)
StdButton(main, text=".", command=lambda: decimal).grid(column=2, row=6)
StdButton(main, text="=", command=lambda: equals(display, saved, operator)).grid(column=3, row=6)
