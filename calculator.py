...
StdButton(main, text="×", command=lambda: (saved := multiply(display))).grid(column=4, row=3)
...
StdButton(main, text="+", command=lambda: (saved := add(display))).grid(column=4, row=5, rowspan=2, sticky=(N,S))
