...
ttk.Button(main, text="").grid(column=3, row=1)
ttk.Button(main, text="").grid(column=2, row=1)
ttk.Button(main, text="").grid(column=1, row=1)
...
ttk.Button(main, text="X").grid(column=4, row=3)
...
ttk.Button(main, text="+").grid(column=4, row=5, rowspan=2)
