...
StdButton(main, text="÷", command=lambda: (currentOperator := divide)).grid(column=4, row=2)
StdButton(main, text="%", command=lambda: percent()).grid(column=0, row=3)
...
StdButton(main, text="×", command=lambda: (currentOperator := multiply)).grid(column=4, row=3)
StdButton(main, text="plch", command=lambda: plus_minus()).grid(column=0, row=4)
...
StdButton(main, text="−", command=lambda: (currentOperator := subtract)).grid(column=4, row=4)
...
StdButton(main, text="+", command=lambda: (currentOperator := add)).grid(column=4, row=5, rowspan=2, sticky=(N,S))
...
StdButton(main, text="=", command=lambda: equals()).grid(column=3, row=6)
